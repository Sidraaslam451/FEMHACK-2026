...
const Dashboard = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-8">
      <h1 className="font-display text-2xl font-semibold text-[#14213D] mb-1">
        Agent Dashboard
      </h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-4">
          <p className="font-display text-2xl font-semibold text-[#14213D]">
            {stats.total}
          </p>
          <p className="text-xs text-gray-500 mt-0.5">Total</p>
        </div>
        <div className="bg-white rounded-xl border border-gray-100 p-4">
          <p className="font-display text-2xl font-semibold text-gray-500">
            {stats.new}
          </p>
          <p className="text-xs text-gray-500 mt-0.5">New</p>
        </div>
        <div className="bg-white rounded-xl border border-gray-100 p-4">
          <p className="font-display text-2xl font-semibold text-[#E8871E]">
            {stats.inProgress}
          </p>
      ...
      {loading ? (
        <div className="space-y-3">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="bg-white border border-gray-100 rounded-xl p-4 h-20 animate-pulse"
            />
          ))}
        </div>
