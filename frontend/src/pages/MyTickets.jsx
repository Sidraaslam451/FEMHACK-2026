  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="font-display text-2xl font-semibold text-[#14213D]">
            My Tickets
          </h1>
      ...
      {loading ? (
        ...
        <div className="bg-white border border-dashed border-gray-300 rounded-xl p-12 text-center">
          <div className="w-12 h-12 rounded-full bg-[#2A6F6F]/10 flex items-center justify-center mx-auto mb-4">
            <span className="text-[#2A6F6F] text-xl">✓</span>
          </div>
          ...
          <Link
            to="/new-ticket"
            className="text-[#2A6F6F] text-sm font-medium hover:underline"
          >
